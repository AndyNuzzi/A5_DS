...
public class EditProfileTest {
    ...
    public void saveChanges2() {
        ...
        alResultado = EditProfile.saveChanges2("", "123", "123",
                "a", "b", "b@gmail.com");
        assertEquals( "DebesIniciarSesionPreviamente",alResultado.get(0));


        alResultado = EditProfile.saveChanges2("a@gmail.com", "123", "456",
                "a", "b", "b@gmail.com");
        assertEquals( "ContraseñaNoCoincide(1)",alResultado.get(0));

        alResultado = EditProfile.saveChanges2("a@gmail.com", "123", "123",
                "", "b", "b@gmail.com");
